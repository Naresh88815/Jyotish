<footer>
    {{-- <div class="footer-container">
      <div class="footer-left">
        <ul>
          ...
          <li><a href="#">हामी बारेमा</a></li>
          <li><a href="#">परामर्शको लागि</a></li>
        </ul>
      </div>
      <div class="footer-center">
        <div>
          ...
          <div class="contacts">
            <ul>
                <li>
                    <img src="{{ asset('images/phone-call.png') }}" height="36" width="36" alt="Phone">
                    <span>9804059852</span>
                </li>
                <li>
                    <img src="{{ asset('images/email.png') }}" height="36" width="36" alt="Email">
                    <span>nareshsah1200@gmail.com</span>
                </li>
            </ul>
        </div>
            ...
            <ul>
                <li class="facebook-link">
                    <a href="https://www.facebook.com" class="social-link">
                        <img src="{{ asset('images/facebook.png') }}" height="36" width="36" alt="Facebook Icon" />
                    </a>
                </li>
                <li class="instagram-link">
                    <a href="https://www.instagram.com" class="social-link">
                        <img src="{{ asset('images/instagram.png') }}" height="36" width="36" alt="Instagram Icon" />
                    </a>
                </li>
                <li class="whatsapp-link">
                    <a href="#" class="social-link">
                        <img src="{{ asset('images/whatsapp.png') }}" height="36" width="36" alt="WhatsApp Icon" />
                    </a>
                </li>
                <li class="twitter-link">
                    <a href="#" class="social-link">
                        <img src="{{ asset('images/twitter.png') }}" height="36" width="36" alt="Twitter Icon" />
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="copyright">
      <p>Copyright © 2024 I All rights reserved to Jyotish</p>
      <p>Powered By: Web Bank</p>
    </div> --}}

    <div class="mt-8 bg-gray-600 pt-9">
            ...
            <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                <div class="md:w-[316px]">
                    ...
                    <div class="mt-[18px] flex gap-4">
                        <!-- Facebook -->
                        <a class="flex items-center justify-center p-3 bg-blue-600 text-white rounded-full hover:bg-blue-700"
                            target="_blank" href="https://www.facebook.com">
                            <span class="iconify text-white w-5 h-5" data-icon="fa-brands:facebook"
                                data-inline="false"></span>
                        </a>

                        <!-- WhatsApp -->
                        <a class="flex items-center justify-center p-3 bg-green-600 text-white rounded-full hover:bg-green-700"
                            target="_blank" href="https://wa.me">
                            <span class="iconify text-white w-5 h-5" data-icon="fa-brands:whatsapp"
                                data-inline="false"></span>
                        </a>

                        <!-- Twitter -->
                        <a class="flex items-center justify-center p-3 bg-blue-400 text-white rounded-full hover:bg-blue-500"
                            target="_blank" href="https://twitter.com">
                            <span class="iconify text-white w-5 h-5" data-icon="fa-brands:twitter"
                                data-inline="false"></span>
                        </a>

                        <!-- Instagram -->
                        <a class="flex items-center justify-center p-3 bg-gradient-to-br from-pink-500 to-purple-500 text-white rounded-full hover:from-pink-600 hover:to-purple-600"
                            target="_blank" href="https://www.instagram.com">
                            <span class="iconify text-white w-5 h-5" data-icon="fa-brands:instagram"
                                data-inline="false"></span>
                        </a>
                    </div>
                </div>
